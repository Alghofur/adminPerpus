          ...
          <table class="table table-hover table-bordered mb-5" id="tabel-data" width="100%" cellspacing="0">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <a href="ubah.php?id=<?= $data['id_buku']; ?>" id="id" class="btn btn-info btn-sm"><i class="bi bi-pen"></i></a>
                            <a href="hapus.php?id=<?= $data['id_buku']; ?>" id="id" class="btn btn-danger btn-sm"><i class="bi bi-trash3-fill" onclick="return confirm('Yakin dek?')"></i></a>
                        </td>
                    </tr>
                    <?php } ?>
                </tbody>
