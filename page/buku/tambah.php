<?php  
 ...
 if(isset($_POST['tambah'])){
  ...
  $sql = $conn->query("INSERT INTO buku VALUES (null, '$judul', '$pengarang', '$penerbit', '$tahun_terbit', '$isbn', '$jumlah', '$lokasi', '$tgl_input')") or die (mysqli_error($conn));
  if($sql){
    ...
    <div class="card-header mb-5">
        <form action="" method="post">
            <div class="form-group">
                <label for="judul_buku" class="small mb-1">Judul Buku</label>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="penerbit_buku" name="penerbit_buku" placeholder="Masukan penerbit buku">
            </div>
            <div class="form-group">
                <label class="samll mb-1" for="tahun_terbit">Tahun Terbit</label>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" id="isbn" name="isbn" type="number" placeholder="Masukan isbn buku">
                </div>
                <div class="form-group">
                    <label class="small mb-1" for="jumlah_buku">Jumlah Buku</label>
                    <input class="form-control" id="jumlah_buku" name="jumlah_buku" type="text" placeholder="Masukan jumlah buku">
                </div>
                <div class="form-group">
